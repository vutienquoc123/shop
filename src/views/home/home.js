...
const Home =  (props) => {
  ...
  useEffect(() => {
    data &&
      dispatch(changeCategory(data.listcategories[0].slug)) &&
      dispatch(changeSubCategory(data.listcategories[0].slug));
  }, [data]);
  ...
  //                 <View key={index} style={{marginTop: 10, flexDirection: 'row',padding:10}}>
  ...
  //               </View>
  //               <View style={{width : WIDTH*0.25,marginLeft:20,marginTop:5}}>
